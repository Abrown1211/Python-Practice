...
totalRatingsOneTwo = 0
totalRatingsNineTen = 0
...
for line in movieRatingsFile:
    ...
    for rating in ratings:
        ...
        if numericRating <= 2:
            totalRatingsOneTwo += 1
        if numericRating >= 9:
            totalRatingsNineTen += 1


coolPct = totalRatingsAboveCool / totalRatings
foolieRatingDelta = totalRatingsOneTwo - totalRatingsNineTen
foolieBadgeRatings = totalRatingsOneTwo + totalRatingsNineTen
foolieBadgePercent = foolieBadgeRatings / totalRatings
...
elif foolieBadgePercent >+ .35 and foolieRatingDelta <= 5:
    rating = "FOOLIE"
    ratingImageFileName = 'fooled-you.gif'
else:
    rating = "DROOL"
